...
public class Registering {
	...
	public void jmndsRegister(int heatingPort, int sprinklerPort, int lightPort, int camPort) throws InterruptedException {
		...
		try {
			...
			ServiceInfo serviceHeating = ServiceInfo.create("_http._tcp.local.", myHeating.getAppliance(), heatingPort,
					"path=index.html");
			ServiceInfo serviceProjector = ServiceInfo.create("_http._tcp.local.", mySprinkler.getAppliance(), sprinklerPort,
					"path=index.html");
